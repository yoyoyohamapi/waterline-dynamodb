...
describe('update', function () {
    ...
    it('destroy success', function(done){
        var options = {
            where: {
                name: 'Simba',
                age: 20
        ...
        Adapter.destroy(identity, 'Tiger', options, function(err){
            if(err) {
    ...
    it('destroy failed when range key have not been defined', function(done){
        var options = {
            where: {
                name: 'Simba'
            }
